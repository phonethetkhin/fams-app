...
import kotlinx.android.synthetic.main.fragment_registration_fail.view.*


class RegistrationFailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_registration_fail, container, false)
